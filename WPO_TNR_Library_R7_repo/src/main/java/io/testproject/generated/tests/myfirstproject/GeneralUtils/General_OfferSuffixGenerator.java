 ...
 */
@Test(
    name = "General_OfferSuffixGenerator",
    description = "This test was auto generated from steps of the 'CreerOffre' test",
    version = "1.0"
)
public class General_OfferSuffixGenerator implements WebTest {
  ...
  public String General_stringOfferSuffix ;
  ...
  public ExecutionResult execute(WebTestHelper helper) throws FailureException {
    ...
    General_stringOfferSuffix = date1+"("+os+"/"+browserName+")";
